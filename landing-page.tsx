...
export default function LandingPage() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-black text-white">
          ...
          <div className="bg-gray-900 p-6 rounded-lg border border-gray-800">
            <ul className="space-y-2">
              {businessInfo.hours.map((item, index) => (
                <li key={index} className="flex justify-between py-2 border-b border-gray-800 last:border-0">
      ...
      {/* Footer */}
      <footer className="w-full bg-gray-900 py-8 px-4 border-t border-gray-800">
        <div className="container mx-auto flex flex-col items-center">
          <p className="text-center mb-4 font-semibold text-xl">Proud Sponsor of The Great Bambinos</p>
          <div className="w-32 h-32 relative mb-4">
            <Image
              src="/placeholder.svg?height=128&width=128"
              alt="The Great Bambinos Team Logo"
              width={128}
              height={128}
